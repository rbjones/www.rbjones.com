% $Id: t047a.tex,v 1.1 2011/05/16 21:40:17 rbj Exp $
...
\title{Formal Semantics and Deductive Methods}
\makeindex
...
\href{http://www.rbjones.com/rbjpub/pp/doc/t047.pdf}
{http://www.rbjones.com/rbjpub/pp/doc/t047.pdf}
...
The subject matter in this case is primarily methodological.
It is an exposition of methods for philosophical reasoning using an interactive theorem prover, together with some of the theoretical background.
