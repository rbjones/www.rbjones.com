% $Id: intro.tex,v 1.4 2009/04/28 13:12:16 rbj Exp $
...
Aritotle's characterisation of {\it first philosophy} is heavily laden with value judgements from which we glean that Aristotle regarded ability in philosophy and those who posess it as superior to all other kinds, and {\it first philosophy} may therefore be seen as an arrogation of superiority by philosophers over other academic disciplines.
