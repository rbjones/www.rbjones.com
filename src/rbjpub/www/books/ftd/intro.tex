% $Id: intro.tex,v 1.17 2015/02/04 06:39:29 rbj Exp $
...
The second concerns the automation of reason, a project which now belongs to the field of artificial intelligence,
conceived here in the manner envisaged by Leibniz rather than as suggested by Turing's \emph{imitation game},

\section{Positive Philosophy}

The terms \emph{positivism} and \emph{positive science} were introduced by August Comte for a philosophy
rooted in the new science introduced by figures such as Bacon and Gallileo, and for a rigourous empirical
science following Compte's understanding of their method.
...
His response to that challenge rested on a distinction between logical and empirical truths,
pushing into the background scepticism about deductive reasoning, while emphasising sceptical
arguments about what can logically be derived from our sensory experience of the world.
...
As we approach the time of Plato we the failure of consensus is crystallised
