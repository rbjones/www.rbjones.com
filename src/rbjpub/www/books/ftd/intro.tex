...
now been surmounted.
\ignore{
It is also now established that there is no possibility of an ``effective'' computational decision procedure for science.
Though David Hilbert had sought such a decusion procedure for mathematics well into the 20th Century, it was eventually shown be Godel that even mathematics is not decidable.
}%ignore
...
For a couple of hundred years before Aristotle, Greek philosophers had been transforming Mathematics into a theoretical science rather than a collection of computational techniques.
This they achieved by deductive reasoning from first principles, in ways which were eventually codified as the ``axiomatic method''.
The axiomatic method proved a successful and reliable way of establishing general principles and detailed theoretical results about geometry and other mathematical topics.
...
\subsubsection{Rigour, Skepticism And Positivism}
