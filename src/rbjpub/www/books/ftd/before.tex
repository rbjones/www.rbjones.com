%$Id: before.tex,v 1.10 2015/04/23 09:58:07 rbj Exp $
...
\ignore{not sure of the detail here!}
...
The dialogue between these has therefore served to refine the distinction between the logical and the empirical.
...
\subsubsection{Two Kinds of Stability}
...
His influence is conspicuous in Russell's\index{Russell} philosophy of logical atomism\cite{russell18} and Wittgenstein's\index{Wittgenstein} Tractatus Logico-Philosophicus \cite{wittgenstein1921}.
