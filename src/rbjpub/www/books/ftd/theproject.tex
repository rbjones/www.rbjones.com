...
Later in the nineteenth century Gottlob Frege, after a period in which mathematicians had begun to apply their technique to logic (previously a pre-occupation exclusive to philosophers) took issue with Kant's position, and set about demonstrating that Mathematics is \emph{analytic}.
...
This he called `begriffsschrift',\index{begriffsschrift} concept script, and though he devised it for mathematics, he considered it adequate for language more generally.
...
He was thus rendered extremely cautious in the construction of the logical system which he would use in that project, which was eventually undertaken jointly with A./N. Whitehead.\index{Whitehead, Alfred North}
