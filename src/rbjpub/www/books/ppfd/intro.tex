...
This book is an exercise in \emph{constructive epistemology}.\index{epistemology!constructive}
\footnote{As distinct from, though not in opposition to, \emph{Constructivist epistemology}}
...
``\emph{constructive epistemology}'', as that term is here used, is philosophy intended to construct or to contribute to the content or structure of epistemes.
...
The perception of epistemes as political power plays, leading to epistemic innovation as a strategem in revolutionary activism, was one aspect of the post-modern philosophy of  Michel Founcault.
The conception of \emph{constructive epistemology} at play is philosophical rather than political, but may nevertheless be construed as a kind of moderate activism.
...
Epistemology, and evolution are intimately connected, I suggest, because evolution is, and epistemes should be, instrumental, and the evolutionary progress is likely, in the long run, is likely to favour those epistemes which are conducive to the evolutionary imperative.

I will argue primarily about features of epistemes which flow from the evolutionary imperative of which my titles speak and that they are not only worthy of consideration for our support, but also the likely product of future evolution.
...
The connection between evolution and epistemology can be illuminated using their connections with the concept of rationality.
...
Evolution may be spoken of in teleological language.
The elaborate organism which evolve do so because they are well adapted to proliferation in their environmental niche.
...
This kind of language should be entered into with a degree of caution, since it suggests that there is some mysterious entity, perhaps called ``nature'', which plays a material role in evolution, which is not the case.
