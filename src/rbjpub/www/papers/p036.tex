...
The for formal basis for such methods are known but too cumbersome to be widely applicable without considerable advances in the available automation.
...
\part{The A Posteriori}

This part concerns the representation and application of empirical knowledge.
...
\cite{kline1990mathematical1,kline1990mathematical2,kline1990mathematical3}
...
\cite{kumar2016self}
\cite{shapiro1991foundations,shapiroHPML}
