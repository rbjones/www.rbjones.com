...
It is this correlation that gives meaning to the representatives or models, and this connection with meanings suggests a broadened conception of language and a way of thinking of knowledge in general as linguistic in character.

A broad conception of knowledge may in this way be associated with a similarly broad conception of language.
Doing so does violence to the meanings hitherto associated with the terms `knowledge' and `language'.
...
It would therefore be appropriate for the broad conceptions of knowldge and of language which I will be addressing to adopt a more cautious nomenclature such as proto-language or proto-knowledge.
I believe that would be cumbersome and ineffective in disarming terminological critique, and will therefore rest exclusively on being as clear as I can about the language I am using, with proliferating too many neologisms in the process.
