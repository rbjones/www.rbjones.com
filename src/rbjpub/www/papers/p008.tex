% $Id: p008.tex,v 1.37 2014/11/08 19:43:29 rbj Exp $
% bibref{rbjp008} pdfname{p008} 

\documentclass[10pt,titlepage]{book}

\usepackage[unicode]{hyperref}
\hypersetup{pdftitle={A Conversation between Carnap and Grice as it might have been}}
...
The education was lightweight, about an hour a day of instruction with an emphasis on understanding rather than on rote learning.
Carnap was encouraged to think for himself.
...
Carnap had the benefit of learning logic from Frege (in whose second course on the {\it Begriffsschrift} Carnap shared Frege's attentions with just two other students).
...
Carnap noted the contrast between mathematics, in which exact and conclusive proofs were the norm, and philosophy with its ``endless controversies''. 
...
In his conception of the theoretical or doctrinal he looks for the standards of hard science (and mathematics), the practical (emotive-ethical) he considers outside the scope of science and philosophy.
