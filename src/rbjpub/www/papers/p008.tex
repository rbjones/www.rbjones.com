% $Id: p008.tex,v 1.27 2010/05/26 19:20:05 rbj Exp $
...
The pathologies of `gladiatorial' philosophical conflict may be seen as arising from or exhibited in various kinds of dogatism.
...
Carnap and Grice are the representatives of two substantially divergent trends in analytic philosophy but each may be seen as a moderating incluence.
...
Carnap and Grice begin at or near these extremes in their early philsophies, but moderate the dogmas as their philosophies mature.
...
For our purposes no detailed discussion of Wittengestein will be necessary, and it may be as well to think instead in terms of the even more simplistic figure \ref{Simpler Approach}.
...
Grice does quote directly from ``Philosophical Investigations'' in WoW:i.
...
\subsection{Lattitudinal Perspective}
...
Wittgenstein's influence does seem to have pushed Carnap further out here than he might othewise have been, but few of the key dogmatic elements which make this position extreme owe their origin to Wittgenstein.
...
Though his own conception of philosophy is narrow, his desire to precribe limits for others fades away in maturity.

\subsection{Grice's Approach}

Austin is here cited as the principle proponent of broadly that kind of ordinary language philosophy with which Grice is concerned throught his life, but also particularly as providing a dogmatic extreme, in which the study of ordinary language not only enlightens our understanding of certain philosophically interesting linguistic phenomena, but also serves to refute philosophers whose theories involve the use of ordinary language in extraordinary ways.
...
\item that the distinction between the physical and mental is not one between kinds of entities, but a differnce of language
...
\item the verification principle, identifying meaning with conditions of verifiability, and meaninfullness as verifiability (in principle).
\end{itemize}
...
\subsection{Demons and Perilous Places}
...
Once these are located and their significance is assessed, as to whether they are points on which an agreement to differ would be acceptable, we can discuss more fully the key areas of dischord in search of resolution.
...
He was scientifically oriented and therefore might have hoped to contribute to a scientific approach to natural languages, and possibly might have thought his general theories of languages to constitute such a contribution, but this probably falls short of embracing the kind of philsophical interest in language typical of Oxonian ordinary language philosophy even as mitigated by Grice.

Fortunately Carnap did explicitly withdraw from prescribing limits to philosophy eventually, but this remains difficult ground on which to find meaningful concensus.
...
Draft $ $Id: p008.tex,v 1.27 2010/05/26 19:20:05 rbj Exp $ $
}%tiny
