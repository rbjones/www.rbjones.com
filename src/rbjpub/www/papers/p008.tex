% $Id: p008.tex,v 1.15 2010/03/02 13:35:31 rbj Exp $
...
Carnap is explicit in regarding philosophy as confined to establishing purely logical results, and as considering the features of ordinary langauges as falling outside this domain.
...
The handwritten version is in the Grice Collection, Bancroft, but most of it is repr. as \cite{grice88c} in \cite{grice88a} (as section II of "Reply to Richards" -- where he drops the "prejudices and predilections").
...
\footnote{Oddly, Berlin does not seem to mention this play group in ``Conversations with Isaiah Berlin'' \cite{berlin91}, mentioning a more diverse group meeting at lunchtime and invluding Austin, Ayer, Hampshire and academics from several other disciplines, possibly a prior to this first ``play group''.}
...
\paragraph{Latitude and Longditude}

Grice talks about the latitudinal and longditudinal unity of philosophy, meaning by these respectively the idea that there is a unity across different subject matters of philosophical enquiry, and that there is a unity through history.
