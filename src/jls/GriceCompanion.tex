% $Id: GriceCompanion.tex,v 1.3 2010/02/17 14:20:35 rbj Exp $
...
Last Change $ $Date: 2010/02/17 14:20:35 $ $

%\href{http://www.jls.rbjones.com//GriceCompanion.pdf}{http://www.jls.rbjones.com/GriceCompanion.pdf}

Draft $ $Id: GriceCompanion.tex,v 1.3 2010/02/17 14:20:35 rbj Exp $ $
}
...
doctorate\cite{speranza95} from the University of Buenos Aires on Grice\index{Grice} -- "Pragmatica Griceana". 
...
\subsection{A Generation Gap}

Carnap\index{Carnap} fought in the Great War. Grice in the 'phoney' 
...
\subsection{The Oxford Circle\index{Circle!Oxford}}

The Berkeley Circle. If Carnap\index{Carnap} was ultimately Vienna 
...
\subsection{Aristotle\index{Aristotle}}

To the 21st century and back.
It really all starts with Aristotle\index{Aristotle}.
Hume is Where the Heart Is, but Kant\index{Kant} is the big influence when we 
...
The  lives and opinions of Carnap\index{Carnap} and Grice.
Grice, as a Brit, would be more familiar with the views of Waismann, the member of the Vienna Circle\index{Circle!Vienna} who 
...
\subsection{Semantics for System G}

Carnap\index{Carnap}'s "meaning postulates" have affinities with 
...
\subsection{Griceland\index{Griceland} and Carnapcopia\index{Carnapcopia} Galore}

It's pretty easy to trace genealogical 
...
Grice cites Hempel\index{Hempel} and Reichenbach\index{Reichenbach} re: atomistic metaphysics in his  
...
specifics in his  "Ontological" essay would have amused G. Indeed Quine\index{Quine} could 
