...
<!-- $Id: IndexFramep.xsl,v 1.1.1.1 2006-04-19 20:44:52 rbj01 Exp $
...
&lt;?php
$docpath="</xsl:text><xsl:value-of select="@path"/><xsl:text disable-output-escaping="yes">";
$docname="</xsl:text><xsl:value-of select="@name"/><xsl:text disable-output-escaping="yes">";
$doctitle="</xsl:text><xsl:value-of select="@title"/><xsl:text disable-output-escaping="yes">";
$domain="</xsl:text><xsl:call-template name="domain"/><xsl:text disable-output-escaping="yes">";
$pid=0;
$suffix="</xsl:text><xsl:call-template name="fsuffix"/><xsl:text disable-output-escaping="yes">";
$docurl="http://$domain/$docpath$docname.$suffix";
$root="</xsl:text><xsl:value-of select="@root"/><xsl:text disable-output-escaping="yes">";

include("</xsl:text><xsl:value-of select="@root"/><xsl:text disable-output-escaping="yes">common/comment.php");
?&gt;
       </xsl:text>
    </table>
  <xsl:call-template name="newline"/>
